...
<template>
    ...
    <div class="shape-container">
        <div class="borderAround shape shape-bottom text-primary-dark">
            <svg width=100% height=auto viewBox="0 0 3000 400" fill="none">
                <path d="M0 400H3000V0L0 400Z" fill="#343A40"></path>
            </svg>
        </div>
        ...
        <div>
            ...
            <div class="col-lg-6 mx-auto">
                <div class="gapAround d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <button type="button" class="gapAround btn btn-outline-info btn-lg px-4 me-sm-3 fw-bold">Register</button>
                    <button type="button" class="gapAround btn btn-outline-light btn-lg px-4">Sign In</button>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <div class="row align-items-md-end py-5 icons-flex">
                <div class="col-md mb-3 mb-md-0">
                    <p class="text-light-grey mb-0">© Mavafiza. 2022 Barcelona-Spain. All rights reserved.</p>
                </div>
